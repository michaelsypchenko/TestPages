...
! function(e) {
        ...
        function c(r, s, u) {
            function m(e, t, n) {
                ...
                var a, r, o, s = [],
                    ...
                    c = v();
                do {
                    !0 === e && h().validPositions[l] ? (r = (o = h().validPositions[l]).match, a = o.locator.slice(), s.push(!0 === n ? o.input : !1 === n ? r.nativeDef : F(l, r))) : (r = (o = b(l, a, l - 1)).match, a = o.locator.slice(), (!1 === u.jitMasking || l < c || "number" == typeof u.jitMasking && isFinite(u.jitMasking) && u.jitMasking > l) && s.push(!1 === n ? r.nativeDef : F(l, r))), l++
            ...
            function k(t, n, a, r) {
                ...
                for (g(!0), o = s + 1; o <= v();) {
                    ...
                    if (o < s && (o = s + 1), h().validPositions[o] === i && _(o)) o++;
                        ...
                        var p = b(o);
                        !1 === c && l[s] && l[s].match.def === p.match.def ? (h().validPositions[s] = e.extend(!0, {}, l[s]), h().validPositions[s].input = p.input, delete h().validPositions[o], o++) : P(s, p.match.def) ? !1 !== O(s, p.input || F(o), !0) && (delete h().validPositions[o], o++, c = !0) : _(o) || (o++, s--), s++
                    }
                }
                g(!0)
            }
            ...
            function y(e, t) {
                for (var n, a = e, r = v(), o = h().validPositions[r] || S(0)[0], s = o.alternation !== i ? o.locator[o.alternation].toString().split(",") : [], l = 0; l < a.length && (!((n = a[l]).match && (u.greedy && !0 !== n.match.optionalQuantifier || (!1 === n.match.optionality || !1 === n.match.newBlockMarker) && !0 !== n.match.optionalQuantifier) && (o.alternation === i || o.alternation !== n.alternation || n.locator[o.alternation] !== i && M(n.locator[o.alternation].toString().split(","), s))) || !0 === t && (null !== n.match.fn || /[0-9a-bA-Z]/.test(n.match.def))); l++);
                return n
            }
            ...
            function S(t, n, a) {
                    ...
                    function p(o, l, g) {
                        ...
                        function k(t, n, a) {
                            ...
                            if (h().validPositions[t - 1] && a && h().tests[t])
                                for (var s = h().validPositions[t - 1].locator, l = h().tests[t][0].locator, c = 0; c < a; c++)
                        ...
                        if (c === t && o.matches === i) return f.push({ match: o, locator: l.reverse(), cd: m }), !0;
                        if (o.matches !== i) {
                            if (o.isGroup && g !== o) {
                                ...
                                if (-1 === w || "string" == typeof w) {
                                    ...
                                    for (var _ = 0; _ < O.length; _++) {
                                        if (C = parseInt(O[_]), f = [], a = k(c, C, A) || M.slice(), !0 !== (o = p(x.matches[C] || n.matches[C], [C].concat(l), g) || o) && o !== i && O[O.length - 1] < x.matches.length) {
                                            var D = e.inArray(o, n.matches) + 1;
                                            n.matches.length > D && (o = p(n.matches[D], [D].concat(l.slice(1, l.length)), g)) && (O.push(D.toString()), e.each(f, function(e, t) {
                                        ...
                                        for (var j = 0; j < b.length; j++) {
                                            ...
                                            for (var F = 0; F < P.length; F++) {
                                                var N = P[F];
                                                if ("string" != typeof w || -1 !== e.inArray(T.locator[T.alternation].toString(), O)) {
                                                    if (function(e, t) {
                                                            return e.match.nativeDef === t.match.nativeDef || e.match.def === t.match.nativeDef || e.match.nativeDef === t.match.def
                                                        }(T, N)) {
                                                        R = !0, T.alternation === N.alternation && -1 === N.locator[N.alternation].toString().indexOf(T.locator[T.alternation]) && (N.locator[N.alternation] = N.locator[N.alternation] + "," + T.locator[T.alternation], N.alternation = T.alternation), T.match.nativeDef === N.match.def && (T.locator[T.alternation] = N.locator[N.alternation], P.splice(P.indexOf(N), 1, T));
                                                        break
                                                    }
                                                    ...
                                                    if (function(e, n) {
                                                        ...
                                                        T.alternation === N.alternation && -1 === T.locator[T.alternation].toString().indexOf(N.locator[N.alternation].toString().split("")[0]) && (T.na = T.na || T.locator[T.alternation].toString(), -1 === T.na.indexOf(T.locator[T.alternation].toString().split("")[0]) && (T.na = T.na + "," + T.locator[N.alternation].toString().split("")[0]), R = !0, T.locator[T.alternation] = N.locator[N.alternation].toString().split("")[0] + "," + T.locator[T.alternation], P.splice(P.indexOf(N), 0, T));
                                                        break
                                                    }
                                                }
                                            }
                                ...
                                for (var I = o, L = a.length > 0 ? a.shift() : 0; L < (isNaN(I.quantifier.max) ? L + 1 : I.quantifier.max) && c <= t; L++) {
                                    var B = n.matches[e.inArray(I, n.matches) - 1];
                                    if (o = p(B, [L].concat(l), B)) {
                                        if (s = f[f.length - 1].match, s.optionalQuantifier = L > I.quantifier.min - 1, v(s, B)) {
                ...
                if (t > -1) {
                    ...
                    for (var k = p.shift(); k < l.length && !(r(l[k], p, [k]) && c === t || c > t); k++);
                }
                return (0 === f.length || d) && f.push({
                    ...
                    locator: [],
                    cd: m
                }), n !== i && h().tests[t] ? o(e.extend(!0, [], f)) : (h().tests[t] = e.extend(!0, [], f), o(h().tests[t]))
            }
            ...
            function M(t, n, a) {
                for (var r, o = u.greedy ? n : n.slice(0, 1), s = !1, l = a !== i ? a.split(",") : [], c = 0; c < l.length; c++) - 1 !== (r = t.indexOf(l[c])) && t.splice(r, 1);
            ...
            function O(t, n, r, o, s, l) {
                ...
                function p(n, a, r) {
                    ...
                    return e.each(S(n), function(l, p) {
                        for (var d = p.match, m = a ? 1 : 0, y = "", b = d.cardinality; b > m; b--) y += T(n - (b - 1));
                        if (a && (y += a), w(!0), !1 !== (s = null != d.fn ? d.fn.test(y, h(), n, r, u, c(t)) : (a === d.def || a === u.skipOptionalPartCharacter) && "" !== d.def && {
                                c: F(n, d, !0) || d.def,
                                pos: n
                            })) {
                            var x = s.c !== i ? s.c : a;
                            x = x === u.skipOptionalPartCharacter && null === d.fn ? F(n, d, !0) || d.def : x;
                            var P = n,
                                S = w();
                            if (s.remove !== i && (e.isArray(s.remove) || (s.remove = [s.remove]), e.each(s.remove.sort(function(e, t) {
                                ...
                                if (C(!0 === A ? A : A.start, A.end, S), s.pos === i && s.c === i) return s.pos = v(), !1;
                                if ((P = s.pos !== i ? s.pos : n) !== n) return s = e.extend(s, O(P, x, !0, o)), !1
                            } else if (!0 !== s && s.pos !== i && s.pos !== n && (P = s.pos, C(n, P, w().slice()), P !== n)) return s = e.extend(s, O(P, x, !0)), !1;
                            return (!0 === s || s.pos !== i || s.c !== i) && (l > 0 && g(!0), f(P, e.extend({}, p, { input: E(x, d, P) }), o, c(t)) || (s = !1), !1)
                        }
                    }), s
                }
                ...
                function f(t, n, a, r) {
                    if (r || u.insertMode && h().validPositions[t] !== i && a === i) {
                        ...
                        for (o = c = t; o <= l; o++) {
                            var y = s[o];
                            if (y !== i)
                                for (var b = c; b < h().maskLength && (null === y.match.fn && f[o] && (!0 === f[o].match.optionalQuantifier || !0 === f[o].match.optionality) || null != y.match.fn);) {
                                    if (b++, !1 === m && s[b] && s[b].match.def === y.match.def) h().validPositions[b] = e.extend(!0, {}, s[b]), h().validPositions[b].input = y.input, d(b), c = b, p = !0;
                                    else if (P(b, y.match.def)) {
                                        var x = O(b, y.input, !0, !0);
                                        p = !1 !== x, c = x.caret || x.insert ? v() : b, m = !0
                ...
                if (e.isFunction(u.preValidation) && !r && !0 !== o && !0 !== l && (x = u.preValidation(w(), m, n, c(t), u)), !0 === x) {
                    if (d(m), c(t) && (H(i, a.keyCode.DELETE, t, !0, !0), m = h().p), m < h().maskLength && (Q === i || m < Q) && (x = p(m, n, r), (!r || !0 === o) && !1 === x && !0 !== l)) {
                        var j = h().validPositions[m];
                        if (!j || null !== j.match.fn || j.match.def !== n && n !== u.skipOptionalPartCharacter) {
                            if ((u.insertMode || h().validPositions[D(m)] === i) && !_(m, !0))
                                            ...
                                            if (a)
                                                for (var r = a.locator, o = r.length, s = t; s < n; s++)
                                                    if (h().validPositions[s] === i && !_(s, !0)) {
                                                        ...
                                                        }), (c = e.extend({}, c, { input: F(s, c.match, !0) || c.match.def })).generatedInput = !0, f(s, c, !0), h().validPositions[n] = i, p(n, a.input, !0)
                                                    }
                                        }(m, x.pos !== i ? x.pos : R), m = R;
                                        break
                                    }
                        } else x = { caret: D(m) }
                    }!1 === x && u.keepStatic && !r && !0 !== s && (x = function(t, n, a) {
                        var r, s, l, c, p, f, d, m, k = e.extend(!0, {}, h().validPositions),
                            y = !1,
                            b = v();
                        for (c = h().validPositions[b]; b >= 0; b--)
                            if ((l = h().validPositions[b]) && l.alternation !== i) {
                                if (r = b, s = h().validPositions[r].alternation, c.locator[l.alternation] !== l.locator[l.alternation]) break;
                                c = l
                            }
                        if (s !== i) {
                            m = parseInt(r);
                            ...
                            e.each(S(m, A ? A.locator : i, m - 1), function(r, l) {
                                ...
                                for (var c = 0; c < d.length; c++) {
                                    var b = [],
                                        ...
                                        A = 0,
                                        w = !1;
                                    if (x < d[c] && (l.na === i || -1 === e.inArray(d[c], l.na.split(",")) || -1 === e.inArray(x.toString(), d))) {
                                        h().validPositions[m] = e.extend(!0, {}, l);
                                        var C = h().validPositions[m].locator;
                                        for (h().validPositions[m].locator[s] = parseInt(d[c]), null == l.match.fn ? (P.input !== l.match.def && (w = !0, !0 !== P.generatedInput && b.push(P.input)), A++, h().validPositions[m].generatedInput = !/[0-9a-bA-Z]/.test(l.match.def), h().validPositions[m].input = l.match.def) : h().validPositions[m].input = P.input, p = m + 1; p < v(i, !0) + 1; p++)(f = h().validPositions[p]) && !0 !== f.generatedInput && /[0-9a-bA-Z]/.test(f.input) ? b.push(f.input) : p < t && S++, delete h().validPositions[p];
                                        for (w && b[0] === l.match.def && b.shift(), g(!0), y = !0; b.length > 0;) {
                                            var E = b.shift();
                                            if (E !== u.skipOptionalPartCharacter && !(y = O(v(i, !0) + 1, E, !1, o, !0))) break
                                        }
                                        if (y) {
                                            h().validPositions[m].locator = C;
                                            var M = v(t) + 1;
                                            for (p = m + 1; p < v() + 1; p++)((f = h().validPositions[p]) === i || null == f.match.fn) && p < t + (A - S) && A++;
            ...
            function D(e, t) {
                ...
                if (e >= n) return n;
                var i = e;
                for (S(n + 1).length > 1 && (m(!0, n + 1, !0), n = h().maskLength); ++i < n && (!0 === t && (!0 !== x(i).match.newBlockMarker || !_(i)) || !0 !== t && !_(i)););
                return i
            }
            ...
            function T(e) {
                return h().validPositions[e] === i ? F(e) : h().validPositions[e].input
            }
            ...
            function R(t, n, a, r, o) {
                ...
                t !== i && (t.inputmask._valueSet(n.join("")), a === i || r !== i && "blur" === r.type ? K(t, a, 0 === n.length) : L(t, a), !0 === o && (Y = !0, e(t).trigger("input")))
            }

            function F(t, n, a) {
                if ((n = n || x(t).match).placeholder !== i || !0 === a) return e.isFunction(n.placeholder) ? n.placeholder(u) : n.placeholder;
                if (null === n.fn) {
            ...
            function N(t, r, o, s, l) {
                ...
                if (-1 === d ? (h().p = D(d), d = 0) : h().p = d, e.each(p, function(n, a) {
                        if (a !== i)
                            if (h().validPositions[n] === i && p[n] === F(n) && _(n, !0) && !1 === O(n, p[n], !0, i, i, !0)) h().p++;
                            else {
                                ...
                                if (!c(d, f) || o || u.autoUnmask) {
                                    var y = o ? n : null == k.match.fn && k.match.optionality && s + 1 < h().p ? s + 1 : h().p;
                                    m = ae.keypressEvent.call(t, r, !0, !1, o, y), d = y + 1, f = ""
                                } else m = ae.keypressEvent.call(t, r, !0, !1, !0, s + 1);
                                if (!1 !== m && !o && e.isFunction(u.onBeforeWrite)) {
                                    var x = m;
                                    if (m = u.onBeforeWrite.call($, r, w(), m.forwardPosition, u), (m = e.extend(x, m)) && m.refreshFromBuffer) {
                                        var P = m.refreshFromBuffer;
                                        C(!0 === P ? P : P.start, P.end, m.buffer), g(!0), m.caret && (h().p = m.caret, m.forwardPosition = m.caret)
                                    }
                                }
                            }
                    }), r) {
                    var P = i;
                    n.activeElement === t && m && (P = u.numericInput ? j(m.forwardPosition) : m.forwardPosition), R(t, w(), P, l || new e.Event("checkval"), l && "input" === l.type)
                }
            }
            ...
            function I(t) {
                ...
                if (e.isFunction(u.onUnMask)) {
                    var s = (J ? w().slice().reverse() : w()).join("");
            ...
            function L(e, a, r, o) {
                function s(e) {
                    return !0 === o || !J || "number" != typeof e || u.greedy && "" === u.placeholder || (e = w().join("").length - e), e
                }
                ...
                if (a.begin !== i && (r = a.end, a = a.begin), "number" == typeof a) {
                    ...
                    if (e.scrollLeft = c > e.scrollWidth ? c : 0, !1 === u.insertMode && a === r && r++, e.inputmask.caretPos = {
                            begin: a,
                            end: r
                        }, e.setSelectionRange) e.selectionStart = a, e.selectionEnd = r;
            ...
            function B(t) {
                ...
                for (n = s + 1; n < r.length; n++) u = (a = b(n, u, n - 1)).locator.slice(), l[n] = e.extend(!0, {}, a);
                var p = c && c.alternation !== i ? c.locator[c.alternation] : i;
                for (n = o - 1; n > s && (((a = l[n]).match.optionality || a.match.optionalQuantifier && a.match.newBlockMarker || p && (p !== l[n].locator[c.alternation] && null != a.match.fn || null === a.match.fn && a.locator[c.alternation] && M(a.locator[c.alternation].toString().split(","), p.toString().split(",")) && "" !== S(n)[0].def)) && r[n] === F(n, a.match)); n--) o--;
                return t ? { l: o, def: l[o] ? l[o].match : i } : o
            }

            function G(e) {
                for (var t, n = B(), a = e.length, r = h().validPositions[v()]; n < a && !_(n, !0) && (t = r !== i ? b(n, r.locator.slice(""), r) : x(n)) && !0 !== t.match.optionality && (!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker || n + 1 === a && "" === (r !== i ? b(n + 1, r.locator.slice(""), r) : x(n + 1)).match.def);) n++;
                for (;
                    (t = h().validPositions[n - 1]) && t && t.match.optionality && t.input === u.skipOptionalPartCharacter;) n--;
                return e.splice(n), e
            }
            ...
            function H(t, n, r, o, s) {
                if ((u.numericInput || J) && (n === a.keyCode.BACKSPACE ? n = a.keyCode.DELETE : n === a.keyCode.DELETE && (n = a.keyCode.BACKSPACE), J)) {
                    var l = r.end;
                ...
                n === a.keyCode.BACKSPACE && (r.end - r.begin < 1 || !1 === u.insertMode) ? (r.begin = j(r.begin), h().validPositions[r.begin] !== i && h().validPositions[r.begin].input === u.groupSeparator && r.begin--) : n === a.keyCode.DELETE && r.begin === r.end && (r.end = _(r.end, !0) && h().validPositions[r.end] && h().validPositions[r.end].input !== u.radixPoint ? r.end + 1 : D(r.end) + 1, h().validPositions[r.begin] !== i && h().validPositions[r.begin].input === u.groupSeparator && r.end++), k(r.begin, r.end, !1, o), !0 !== o && function() {
                    if (u.keepStatic) {
                        for (var n = [], a = v(-1, !0), r = e.extend(!0, {}, h().validPositions), o = h().validPositions[a]; a >= 0; a--) {
                            ...
                            if (s) {
                                if (!0 !== s.generatedInput && /[0-9a-bA-Z]/.test(s.input) && n.push(s.input), delete h().validPositions[a], s.alternation !== i && s.locator[s.alternation] !== o.locator[s.alternation]) break;
                                o = s
                            }
                        }
                        if (a > -1)
            ...
            function K(e, t, a) {
                ...
                if (Z !== i) {
                    var m = w();
                    if (t === i ? t = L(e) : t.begin === i && (t = { begin: t, end: t }), !0 !== a) {
                        var g = v();
                        do {
                            o(), h().validPositions[d] ? (l = h().validPositions[d], s = l.match, c = l.locator.slice(), r(), p += m[d]) : (l = b(d, c, d - 1), s = l.match, c = l.locator.slice(), (!1 === u.jitMasking || d < g || "number" == typeof u.jitMasking && isFinite(u.jitMasking) && u.jitMasking > d) && (r(), p += F(d, s))), d++
                        } while ((Q === i || d < Q) && (null !== s.fn || "" !== s.def) || g > d || f); -
                ...
                ae = {
                    keydownEvent: function(t) {
                        var n = this,
                            ...
                            r = t.keyCode,
                            o = L(n);
                        if (r === a.keyCode.BACKSPACE || r === a.keyCode.DELETE || d && r === a.keyCode.BACKSPACE_SAFARI || t.ctrlKey && r === a.keyCode.X && !l("cut")) t.preventDefault(), H(n, r, o), R(n, w(!0), h().p, t, n.inputmask._valueGet() !== w().join("")), n.inputmask._valueGet() === A().join("") ? i.trigger("cleared") : !0 === U(w()) && i.trigger("complete");
                        else if (r === a.keyCode.END || r === a.keyCode.PAGE_DOWN) {
                            t.preventDefault();
                            var s = D(v());
                            u.insertMode || s !== h().maskLength || t.shiftKey || s--, L(n, t.shiftKey ? o.begin : s, s, !0)
                        ...
                        }, 0)) : (u.insertMode = !u.insertMode, L(n, u.insertMode || o.begin !== h().maskLength ? o.begin : o.begin - 1));
                        u.onKeyDown.call(this, t, w(), L(n).begin, u), ee = -1 !== e.inArray(r, u.ignorables)
                    },
                    keypressEvent: function(t, n, r, o, s) {
                        var l = this,
                            c = e(l),
                            p = t.which || t.charCode || t.keyCode;
                        if (!(!0 === n || t.ctrlKey && t.altKey) && (t.ctrlKey || t.metaKey || ee)) return p === a.keyCode.ENTER && z !== w().join("") && (z = w().join(""), setTimeout(function() {
                            c.trigger("change")
                        }, 0)), !0;
                        if (p) {
                            46 === p && !1 === t.shiftKey && "" !== u.radixPoint && (p = u.radixPoint.charCodeAt(0));
                            var f, d = n ? { begin: s, end: s } : L(l),
                                m = String.fromCharCode(p);
                            h().writeOutBuffer = !0;
                            var v = O(d, m, o);
                            if (!1 !== v && (g(!0), f = v.caret !== i ? v.caret : n ? v.pos + 1 : D(v.pos), h().p = f), !1 !== r && (setTimeout(function() {
                                    u.onKeyValidation.call(l, p, v, u)
                                }, 0), h().writeOutBuffer && !1 !== v)) {
                                var k = w();
                                R(l, k, u.numericInput && v.caret === i ? j(f) : f, t, !0 !== n), !0 !== n && setTimeout(function() {
                    ...
                    pasteEvent: function(n) {
                        ...
                        if (c === (J ? A().reverse() : A()).slice(0, l.begin).join("") && (c = ""), p === (J ? A().reverse() : A()).slice(l.end).join("") && (p = ""), J && (i = c, c = p, p = i), t.clipboardData && t.clipboardData.getData) s = c + t.clipboardData.getData("Text") + p;
                        else {
                        ...
                        if (e.isFunction(u.onBeforePaste)) {
                            if (!1 === (f = u.onBeforePaste.call($, s, u))) return n.preventDefault();
                            f || (f = s)
                        }
                        return N(a, !1, !1, J ? f.split("").reverse() : f.toString().split("")), R(a, w(), D(v()), n, z !== w().join("")), !0 === U(w()) && o.trigger("complete"), n.preventDefault()
                    },
                    inputFallBackEvent: function(t) {
                        ...
                        if (w().join("") !== i) {
                            ...
                            if (i = function(e, t, n) {
                                    ...
                                    return t
                                }(0, i, r), r.begin > i.length && (L(n, i.length), r = L(n)), w().join("") !== i) {
                                var o = w().join(""),
                                ...
                                if (c !== d && (c.length > d.length ? h += c.slice(0, 1) : c.length < d.length && (m.end += d.length - c.length, g || "" === u.radixPoint || "" !== c || l.charAt(m.begin + s - 1) !== u.radixPoint || (m.begin--, h = u.radixPoint))), R(n, w(), {
                                        begin: m.begin + s,
                                        end: m.end + s
                                    ...
                                    m.begin === m.end - 1 && (m.begin = j(m.begin + 1), m.begin === m.end - 1 ? L(n, m.begin) : L(n, m.begin, m.end));
                                    var y = new e.Event("keydown");
                                    y.keyCode = a.keyCode.DELETE, ae.keydownEvent.call(n, y), !1 === u.insertMode && L(n, L(n).begin - 1)
                                }
                                t.preventDefault()
                            }
                        }
                    ...
                    setValueEvent: function(t) {
                        ...
                        e.isFunction(u.onBeforeMask) && (i = u.onBeforeMask.call($, i, u) || i), i = i.split(""), N(n, !0, !1, J ? i.reverse() : i), z = w().join(""), (u.clearMaskOnLostFocus || u.clearIncomplete) && n.inputmask._valueGet() === A().join("") && n.inputmask._valueSet("")
                    },
                    focusEvent: function(e) {
                        var t = this,
                            n = t.inputmask._valueGet();
                        u.showMaskOnFocus && (!u.showMaskOnHover || u.showMaskOnHover && "" === n) && (t.inputmask._valueGet() !== w().join("") ? R(t, w(), D(v())) : !1 === te && L(t, D(v()))), !0 === u.positionCaretOnTab && !1 === te && "" !== n && (R(t, w(), L(t)), ae.clickEvent.apply(t, [e, !0])), z = w().join("")
                    },
                    mouseleaveEvent: function(e) {
                        ...
                        if (te = !1, u.clearMaskOnLostFocus && n.activeElement !== t) {
                            ...
                            a !== t.getAttribute("placeholder") && "" !== a && (-1 === v() && a === A().join("") ? i = [] : G(i), R(t, i))
                        }
                    },
                    clickEvent: function(t, a) {
                        ...
                        setTimeout(function() {
                            if (n.activeElement === o) {
                                var e = L(o);
                                if (a && (J ? e.end = e.begin : e.begin = e.end), e.begin === e.end) switch (u.positionCaretOnClick) {
                                    case "none":
                                        break;
                                    case "radixFocus":
                                        if (r(e.begin)) {
                                            var t = w().join("").indexOf(u.radixPoint);
                                    ...
                                    default:
                                        ...
                                        if (s < c) L(o, _(s, !0) || _(s - 1, !0) ? s : D(s));
                                            ...
                                            var p = h().validPositions[l],
                                                ...
                                                d = F(c, f.match);
                                            if ("" !== d && w()[c] !== d && !0 !== f.match.optionalQuantifier && !0 !== f.match.newBlockMarker || !_(c, !0) && f.match.def === d) {
                                                var m = D(c);
                                                (s >= m || s === c) && (c = m)
                                            }
                                            L(o, c)
                    ...
                    cutEvent: function(i) {
                        ...
                        c.setData("text", J ? u.reverse().join("") : u.join("")), n.execCommand && n.execCommand("copy"), H(r, a.keyCode.DELETE, s), R(r, w(), h().p, i, z !== w().join("")), r.inputmask._valueGet() === A().join("") && o.trigger("cleared")
                    },
                    blurEvent: function(t) {
                        ...
                        if (a.inputmask) {
                            var r = a.inputmask._valueGet(),
                                o = w().slice();
                            "" !== r && (u.clearMaskOnLostFocus && (-1 === v() && r === A().join("") ? o = [] : G(o)), !1 === U(o) && (setTimeout(function() {
                                n.trigger("incomplete")
                            }, 0), u.clearIncomplete && (g(), o = u.clearMaskOnLostFocus ? [] : A().slice())), R(a, o, i, t)), z !== w().join("") && (z = o.join(""), n.trigger("change"))
                        }
                    },
                    mouseenterEvent: function(e) {
                        var t = this;
                        te = !0, n.activeElement !== t && u.showMaskOnHover && t.inputmask._valueGet() !== w().join("") && R(t, w())
                    },
            ...
            if (r !== i) switch (r.action) {
                case "isComplete":
                    return q = r.el, U(w());
                case "unmaskedvalue":
                    return q !== i && r.value === i || (re = r.value, re = (e.isFunction(u.onBeforeMask) ? u.onBeforeMask.call($, re, u) || re : re).split(""), N(i, !1, !1, J ? re.reverse() : re), e.isFunction(u.onBeforeWrite) && u.onBeforeWrite.call($, i, w(), 0, u)), I(q);
                case "mask":
                    ! function(t) {
                        ie.off(t);
                        var a = function(t, a) {
                            ...
                            return !1 !== s ? function(t) {
                                function r() {
                                    return this.inputmask ? this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : -1 !== v() || !0 !== a.nullable ? n.activeElement === this && a.clearMaskOnLostFocus ? (J ? G(w().slice()).reverse() : G(w().slice())).join("") : l.call(this) : "" : l.call(this)
                                }
                                ...
                                if (!t.inputmask.__valueGet) {
                                    ...
                                    t.inputmask._valueGet = function(e) {
                                        ...
                                        c.call(this.el, null === e || e === i ? "" : !0 !== t && J ? e.split("").reverse().join("") : e)
                                    }, l === i && (l = function() {
                                        return this.value
                                    }, c = function(e) {
                                        this.value = e
                        ...
                        if (!1 !== a && (q = t, W = e(q), -1 === (Q = q !== i ? q.maxLength : i) && (Q = i), !0 === u.colorMask && V(q), p && (q.hasOwnProperty("inputmode") && (q.inputmode = u.inputmode, q.setAttribute("inputmode", u.inputmode)), "true" === u.disablePredictiveText && (!0 !== u.colorMask && V(q), q.type = "password")), !0 === a && (ie.on(q, "submit", ae.submitEvent), ie.on(q, "reset", ae.resetEvent), ie.on(q, "mouseenter", ae.mouseenterEvent), ie.on(q, "blur", ae.blurEvent), ie.on(q, "focus", ae.focusEvent), ie.on(q, "mouseleave", ae.mouseleaveEvent), !0 !== u.colorMask && ie.on(q, "click", ae.clickEvent), ie.on(q, "dblclick", ae.dblclickEvent), ie.on(q, "paste", ae.pasteEvent), ie.on(q, "dragdrop", ae.pasteEvent), ie.on(q, "drop", ae.pasteEvent), ie.on(q, "cut", ae.cutEvent), ie.on(q, "complete", u.oncomplete), ie.on(q, "incomplete", u.onincomplete), ie.on(q, "cleared", u.oncleared), p || !0 === u.inputEventOnly ? q.removeAttribute("maxLength") : (ie.on(q, "keydown", ae.keydownEvent), ie.on(q, "keypress", ae.keypressEvent)), ie.on(q, "compositionstart", e.noop), ie.on(q, "compositionupdate", e.noop), ie.on(q, "compositionend", e.noop), ie.on(q, "keyup", e.noop), ie.on(q, "input", ae.inputFallBackEvent), ie.on(q, "beforeinput", e.noop)), ie.on(q, "setvalue", ae.setValueEvent), z = A().join(""), "" !== q.inputmask._valueGet(!0) || !1 === u.clearMaskOnLostFocus || n.activeElement === q)) {
                            var r = e.isFunction(u.onBeforeMask) ? u.onBeforeMask.call($, q.inputmask._valueGet(!0), u) || q.inputmask._valueGet(!0) : q.inputmask._valueGet(!0);
                            "" !== r && N(q, !0, !1, J ? r.split("").reverse() : r.split(""));
                            var s = w().slice();
                            z = s.join(""), !1 === U(s) && u.clearIncomplete && g(), u.clearMaskOnLostFocus && n.activeElement !== q && (-1 === v() ? s = [] : G(s)), R(q, s), n.activeElement === q && L(q, D(v()))
                        }
                    }(q);
                    break;
                case "format":
                    return re = (e.isFunction(u.onBeforeMask) ? u.onBeforeMask.call($, r.value, u) || r.value : r.value).split(""), N(i, !0, !1, J ? re.reverse() : re), r.metadata ? {
                        value: J ? w().slice().reverse().join("") : w().join(""),
                        metadata: c.call(this, { action: "getmetadata" }, s, u)
                    } : J ? w().slice().reverse().join("") : w().join("");
                case "isValid":
                    r.value ? (re = r.value.split(""), N(i, !0, !0, J ? re.reverse() : re)) : r.value = w().join("");
                    for (var oe = w(), se = B(), le = oe.length - 1; le > se && !_(le); le--);
                    return oe.splice(se, le + 1 - se), U(oe) && r.value === w().join("");
                case "getemptymask":
                    return A().join("");
                case "remove":
                    if (q && q.inputmask) {
                        W = e(q), q.inputmask._valueSet(u.autoUnmask ? I(q) : q.inputmask._valueGet(!0)), ie.off(q), q.inputmask.colorMask && ((Z = q.inputmask.colorMask).removeChild(q), Z.parentNode.insertBefore(q, Z), Z.parentNode.removeChild(Z));
                        Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(q), "value") && q.inputmask.__valueGet && Object.defineProperty(q, "value", {
                            get: q.inputmask.__valueGet,
                            set: q.inputmask.__valueSet,
                            configurable: !0
                        }) : n.__lookupGetter__ && q.__lookupGetter__("value") && q.inputmask.__valueGet && (q.__defineGetter__("value", q.inputmask.__valueGet), q.__defineSetter__("value", q.inputmask.__valueSet)), q.inputmask = i
                    }
                    return q;
                case "getmetadata":
        ...
        return a.prototype = {
            ...
            mask: function(o) {
                ...
                return "string" == typeof o && (o = n.getElementById(o) || n.querySelectorAll(o)), o = o.nodeName ? [o] : o, e.each(o, function(t, n) {
                    ...
                    o !== i && (n.inputmask !== i && (n.inputmask.opts.autoUnmask = !0, n.inputmask.remove()), n.inputmask = new a(i, i, !0), n.inputmask.opts = r, n.inputmask.noMasksCache = u.noMasksCache, n.inputmask.userOptions = e.extend(!0, {}, u.userOptions), n.inputmask.isRTL = r.isRTL || r.numericInput, n.inputmask.el = n, n.inputmask.maskset = o, e.data(n, "_inputmask_opts", r), c.call(n.inputmask, { action: "mask" }))
            ...
            analyseMask: function(t, n, r) {
                ...
                var p, f, d, m, h, g, v, k = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g,
                    y = /\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9][0-9]*|x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-9]+(?:,[0-9]*)?\})\??|[^.?*+^${[()|\\]+|./g,
                    b = !1,
                    x = new o,
                    P = [],
                    S = [];
                for (n && (r.optionalmarker.start = i, r.optionalmarker.end = i); p = n ? y.exec(t) : k.exec(t);) {
                    ...
                    if (b) c();
                        ...
                        case r.quantifiermarker.start:
                            ...
                            if ("*" !== M && "+" !== M || (E = "*" === M ? 0 : 1), w.quantifier = {
                                    min: E,
                                    max: M
                                }, P.length > 0) {
                                var O = P[P.length - 1].matches;
                                (p = O.pop()).isGroup || ((v = new o(!0)).matches.push(p), p = v), O.push(p), O.push(w)
                            } else(p = x.matches.pop()).isGroup || (n && null === p.fn && "." === p.def && (p.fn = new RegExp(p.def, r.casing ? "i" : "")), (v = new o(!0)).matches.push(p), p = v), x.matches.push(p), x.matches.push(w);
                            break;
                        case r.alternatormarker:
                            if (P.length > 0) {
                                var _ = (m = P[P.length - 1]).matches[m.matches.length - 1];
                                g = m.openGroup && (_.matches === i || !1 === _.isGroup && !1 === _.isAlternator) ? P.pop() : m.matches.pop()
    ...
    function u(e, t) {
        ...
        if (t.singleton) {
            var c = k++;
            n = v || (v = s(t)), i = p.bind(null, n, c, !1), a = p.bind(null, n, c, !0)
    ...
    ! function(o) {
        ...
        function r(t, i) {
            for (var a, r = ""; a = n(i).exec(t);) r += s[a[0]] ? "(" + (e.isFunction(s[a[0]]) ? s[a[0]](i.min, i.max) : s[a[0]]) + ")" : a[0];
            return r
        }
        ...
        function o(e, t, i) {
            ...
            if ("string" == typeof c) {
                for (; o = n(i).exec(t);)
                    ...
                    var u = c.split(o[0])[0];
                    "year" === r ? (l[r] = a(u), l["raw" + r] = u) : l[r] = i.min && u.match(/[^0-9]/) ? i.min[r] : u, c = c.slice((u + o[0]).length), r = void 0
                }
                return void 0 !== r && ("year" === r ? (l[r] = a(c), l["raw" + r] = c) : l[r] = c.replace(/[^0-9]/g, "0")), l.date = new Date(l.year + "-" + l.month + "-" + l.day + "T" + l.hour + ":" + l.minutes + ":" + l.seconds), l
            }
        }
            ...
            datetime: {
                ...
                postValidation: function(e, t, n) {
                    var r = o(e.join(""), n.inputFormat, n),
                        s = t;
                    return s && isFinite(r.rawyear) && (s = s && ("29" !== r.day || !i(r.rawyear))), s && r.date.getTime() === r.date.getTime() && (s = s && a(r.date, n)), s
                },
                onKeyDown: function(i, a, r, o) {
                    var s = this;
                    if (i.ctrlKey && i.keyCode === t.keyCode.RIGHT) {
                        for (var l, c = new Date, u = ""; l = n(o).exec(o.inputFormat);) "d" === l[0].charAt(0) ? u += c.getDate().toString() : "m" === l[0].charAt(0) ? u += (c.getMonth() + 1).toString() : "yyyy" === l[0] ? u += c.getFullYear().toString() : "yy" === l[0] && (u += c.getYear().toString());
            ...
            numeric: {
                ...
                preValidation: function(t, i, a, r, o) {
                    ...
                    if (!1 === r && a === o.radixPoint && o.digits !== n && (isNaN(o.digits) || parseInt(o.digits) > 0)) {
                        ...
                        if (-1 !== s) return !0 === o.numericInput ? i === s : { caret: s + 1 }
                    }
                    return !0
                },
                postValidation: function(i, a, r) {
                    ...
                    if (p = p.replace(o, ""), p = p.replace(new RegExp(t.escapeRegex(r.groupSeparator), "g"), ""), p = p.replace(new RegExp("[-" + t.escapeRegex(r.negationSymbol.front) + "]", "g"), ""), p = p.replace(new RegExp(t.escapeRegex(r.negationSymbol.back) + "$"), ""), isNaN(r.placeholder) && (p = p.replace(new RegExp(t.escapeRegex(r.placeholder), "g"), "")), p.length > 1 && 1 !== p.indexOf(r.radixPoint) && ("0" === u && (p = p.replace(/^\?/g, "")), p = p.replace(/^0/g, "")), p.charAt(0) === r.radixPoint && "" !== r.radixPoint && !0 !== r.numericInput && (p = "0" + p), "" !== p) {
                        if (p = p.split(""), (!r.digitsOptional || r.enforceDigitsOnBlur && "blur" === a.event) && isFinite(r.digits)) {
                            ...
                            for (var m = 1; m <= r.digits; m++) r.digitsOptional && (!r.enforceDigitsOnBlur || "blur" !== a.event) || p[f + m] !== n && p[f + m] !== r.placeholder.charAt(0) ? -1 !== d && c[d + m] !== n && (p[f + m] = p[f + m] || c[d + m]) : p[f + m] = a.placeholder || r.placeholder.charAt(0)
                        }
                        if (!0 !== r.autoGroup || "" === r.groupSeparator || u === r.radixPoint && a.pos === n && !a.dopost) p = p.join("");
                        else {
                    ...
                    if (r.isNegative && "blur" === a.event && (r.isNegative = "0" !== p), p = s + p, p += o, r.isNegative && (p = r.negationSymbol.front + p, p += r.negationSymbol.back), p = p.split(""), u !== n)
                        if (u !== r.radixPoint && u !== r.negationSymbol.front && u !== r.negationSymbol.back)(l = e.inArray("?", p)) > -1 ? p[l] = u : l = a.caret || 0;
                ...
                definitions: {
                    "~": {
                        validator: function(e, i, a, r, o, s) {
                            ...
                            } else r || e !== o.radixPoint || i.validPositions[a - 1] !== n || (i.buffer[a] = "0", l = { pos: a + 1 });
                            return l
                        },
                        cardinality: 1
                    },
    ...
    ! function(o) {
        ...
        return t.prototype.analyseMask = function(t, n, a) {
            ...
            var s = {};
            return a.phoneCodes && (a.phoneCodes && a.phoneCodes.length > 1e3 && (r((t = t.substr(1, t.length - 2)).split(a.groupmarker.end + a.alternatormarker + a.groupmarker.start)), t = o(s)), t = t.replace(/9/g, "\\9")), i.call(this, t, n, a)
        }, t.extendAliases({
            abstractphone: {
                groupmarker: { start: "<", end: ">" },
                countrycode: "",
